...
-- Black Moonstone
walls.register("too_many_stones:black_moonstone_wall", "Black Moonstone Wall", "tms_black_moonstone.png",
		"too_many_stones:black_moonstone", too_many_stones.node_sound_glass_defaults())
		
walls.register("too_many_stones:black_moonstone_brick_wall", "Black Moonstone Brick Wall", "tms_black_moonstone_brick.png",
		"too_many_stones:black_moonstone_brick", too_many_stones.node_sound_glass_defaults())

walls.register("too_many_stones:black_moonstone_cracked_brick_wall", "Cracked Black Moonstone Brick Wall", "tms_black_moonstone_cracked_brick.png",
		"too_many_stones:black_moonstone_cracked_brick", too_many_stones.node_sound_glass_defaults())

walls.register("too_many_stones:black_moonstone_block_wall", "Black Moonstone Block Wall", "tms_black_moonstone_block.png",
...
-- Fluorite
walls.register("too_many_stones:fluorite_wall", "Fluorite Wall", "tms_fluorite.png",
		"too_many_stones:fluorite", too_many_stones.node_sound_glass_defaults())
		
walls.register("too_many_stones:fluorite_brick_wall", "Fluorite Brick Wall", "tms_fluorite_brick.png",
		"too_many_stones:fluorite_brick", too_many_stones.node_sound_glass_defaults())

walls.register("too_many_stones:fluorite_cracked_brick_wall", "Cracked Fluorite Brick Wall", "tms_fluorite_cracked_brick.png",
		"too_many_stones:fluorite_cracked_brick", too_many_stones.node_sound_glass_defaults())

walls.register("too_many_stones:fluorite_block_wall", "Fluorite Block Wall", "tms_fluorite_block.png",
...
-- Yellow Granite
walls.register("too_many_stones:granite_yellow_wall", "Yellow Granite Wall", "tms_granite_yellow.png",
		"too_many_stones:granite_yellow", too_many_stones.node_sound_stone_defaults())
		
walls.register("too_many_stones:granite_yellow_brick_wall", "Yellow Granite Brick Wall", "tms_granite_yellow_brick.png",
		"too_many_stones:granite_yellow_brick", too_many_stones.node_sound_stone_defaults())

walls.register("too_many_stones:granite_yellow_cracked_brick_wall", "Cracked Yellow Granite Brick Wall", "tms_granite_yellow_cracked_brick.png",
		"too_many_stones:granite_yellow_cracked_brick", too_many_stones.node_sound_stone_defaults())

walls.register("too_many_stones:granite_yellow_block_wall", "Yellow Granite Block Wall", "tms_granite_yellow_block.png",
		"too_many_stones:granite_yellow_block", too_many_stones.node_sound_stone_defaults())

walls.register("too_many_stones:granite_yellow_cobble_wall", "Cobbled Black Granite Wall", "tms_granite_yellow_cobble.png",
...
-- Morion Quartz
walls.register("too_many_stones:morion_quartz_wall", "Morion Quartz Wall", "tms_morion_quartz.png",
		"too_many_stones:morion_quartz", too_many_stones.node_sound_glass_defaults())
		
walls.register("too_many_stones:morion_quartz_brick_wall", "Morion Quartz Brick Wall", "tms_morion_quartz_brick.png",
		"too_many_stones:morion_quartz_brick", too_many_stones.node_sound_glass_defaults())

walls.register("too_many_stones:morion_quartz_cracked_brick_wall", "Cracked Morion Quartz Brick Wall", "tms_morion_quartz_cracked_brick.png",
		"too_many_stones:morion_quartz_cracked_brick", too_many_stones.node_sound_glass_defaults())

walls.register("too_many_stones:morion_quartz_block_wall", "Morion Quartz Block Wall", "tms_morion_quartz_block.png",
...
-- Yellow Travertine
walls.register("too_many_stones:travertine_yellow_wall", "Yellow Travertine Wall", "tms_travertine_yellow.png",
		"too_many_stones:travertine_yellow", too_many_stones.node_sound_stone_defaults())
		
walls.register("too_many_stones:travertine_yellow_brick_wall", "Yellow Travertine Brick Wall", "tms_travertine_yellow_brick.png",
		"too_many_stones:travertine_yellow_brick", too_many_stones.node_sound_stone_defaults())

walls.register("too_many_stones:travertine_yellow_cracked_brick_wall", "Cracked Yellow Travertine Brick Wall", "tms_travertine_yellow_cracked_brick.png",
		"too_many_stones:travertine_yellow_cracked_brick", too_many_stones.node_sound_stone_defaults())

walls.register("too_many_stones:travertine_yellow_block_wall", "Yellow Travertine Block Wall", "tms_travertine_yellow_block.png",
